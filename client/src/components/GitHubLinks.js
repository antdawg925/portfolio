        ...
        <div className="bx-ctr">
            <div className="flex">
                ...
                <div className="b-shdw">
                    ...
                    <div className="group">
                        <p> 
                            TensorFlow model makes live predictions of the objects that appear is your webcam. 
                            3D objects were created with Three.js to enhance the UI and create a memorable UX.
                            Some examples of designs are provided for clients.
                        </p>
                        
                    </div>
                    <p onClick={() => git3()}className="b-fixed in-shdw">
                ...
                <div className="b-shdw">
                    ...
                    <div className="group">
                        <p> React.Js and Chart.Js display stock trading information for users to observe average returns, collect ticker information, 
                            and what sectors they are trading most. JavaScript server manages routes to MongoDB to save trade information.
                        </p>
