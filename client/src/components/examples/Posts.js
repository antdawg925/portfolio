        ...
        <div className="form-box form">
            ...
            <div className="border post">
                ...
                <div className="flex">
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/128/4615/4615740.png" alt="avi1" height={"40rem"} />&nbsp;&nbsp;&nbsp;
                    <p>@McArthurIII</p>
            ...
            <div className="border post">
                ...
                <div className="flex">
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/128/4615/4615665.png" alt="avi1" height={"40rem"} />&nbsp;&nbsp;&nbsp;
                    <p>@2Sweezy</p>
            ...
            <div className="border post">
                ...
                <div className="flex">
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/128/4615/4615643.png" alt="avi1" height={"40rem"} />&nbsp;&nbsp;&nbsp;
                    <p>@Jermaine4202</p>
